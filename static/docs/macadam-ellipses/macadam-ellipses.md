...
c: "<p>The MacAdam ellipses, or SDCM (standard deviation of color matching), are standard deviations of perceived color differences in LED binning including white LEDs. The higher the step or standard deviation, the lower the binning tolerances which lowers LED costs. 
    ...
    <p>To make it simple and practical, <strong>only in a 1-step MacAdam ellipse for white LEDs are any variations in the white light unperceived to most people</strong>. In a 2-step MacAdam ellipse variations may just be perceivable to a trained eye, and in a 3-step MacAdam ellipse variations may be just perceivable to an untrained eye</p>
