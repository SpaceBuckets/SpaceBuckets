...
export default {
  async asyncData({route}) {
    ...
    var posts = await filterBuilds(36, route.params.page, "pop",route.params.category.replace(/-/g,','));
    var megaposts = await filterBuilds(-1, 0, "pop",route.params.category.replace(/-/g,','));
  ...
  head() {
    return {
      title: `Space Buckets - GALLERY - ${this.$route.params.category}`,
